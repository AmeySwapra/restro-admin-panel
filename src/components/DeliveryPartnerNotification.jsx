...
const DeliveryNotification = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, message: "New delivery assignment available. Please check your app.", isEditing: false },
    { id: 2, message: "Delivery cancelled. Check for your next assignment.", isEditing: false },
  ]);
  ...
  return (
    <Box borderWidth="1px" borderRadius="lg" p={5} m={3}>
      <Text fontSize="xl" mb={4}>Delivery Partner Notifications</Text>
